...
from pkl import calculate_pkl, test_pkl, pkl_print_visualizations
...
#                         boxes_pred_1,
    ...
    def calc_sample_crit_GOAL2_unique_param(self, 
        ...
        info, all_pkls, gtdist, preddist, gtxs, predxs, createdimages  = pkl_print_visualizations(self.gt_boxes, 
                                box_tmp,
                                listtoken, self.nusc,
                                nusc_maps, device,
                                nworkers=nworkers, bsz=16,
    ...
    def calc_sample_crit_GOAL3_bis(self,
                               listtoken: List[str], 
                               conf_th=0.4, #confidence threshold
                               crit=0.6,#criticality
                               correction_factor=None,
...
#                                     boxes_pred_1=self.pred_boxes,
    ...
    def filter_boxes_confidence_criticalityGOAL3(self, pred_boxes, filtering_condition, conf_th: float =0.4, crit: float =0.8):
        """
